...
export class RavintolatService {
  ...
  public createRavintola(Osoite:string, RavintolaNimi:string): Promise<Ravintola> {
       return this._http.post(this.actionUrl, JSON.stringify({osoite:Osoite, ravintolaNimi: RavintolaNimi}), {headers: this.headers})
         .toPromise()
